(function(d,w,_RB) {
  ...
  var init = function() {
    var sources = atob(RB.source).split("|")
      , source = sources[0]
      , baseUrl = RB.baseUrl || "https://r2kt3s7m.mercury.com/v2/rb?"
      ...
      var VERSION = {"script_version":"wxyz.rb.js"}
        , COOKIE_KEY = "rbuid"
      ...
      RB.jsonPError = function() {
        var scriptId = '_rockerbox_cname_jsonP_script';
        if (document.getElementById(scriptId) !== null) return;
        var jsonP = document.createElement('script');
        jsonP.src = "https://r2kt3s7m.mercury.com/jpuid?jsonp=RB.jsonPUID";
        jsonP.id = scriptId;
        var firstScript = document.getElementsByTagName('script')[0];
        var target = firstScript && firstScript.parentNode || document.head;
        target.appendChild(jsonP);
      ...
      var Integrations = {
        ...
        , jsonP: function() {
            ...
            if (document.getElementById(scriptId) !== null) return;
            var jsonP = document.createElement('script');
            jsonP.src = "https://r2kt3s7m.mercury.com/integrations?source="+source;
            jsonP.id = scriptId;
            var firstScript = document.getElementsByTagName('script')[0];
            var target = firstScript && firstScript.parentNode || document.head;
            target.appendChild(jsonP);
